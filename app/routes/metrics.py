...
@metrics_router.get("/", response_description="List all Metrics", response_model=List[HealthMetricsResponse])
...
@metrics_router.get("/{id}", response_description="Get Metrics by health ID", response_model=HealthMetricsResponse)
